...
/**
 * @Description 客户端处理服务端的handle
 * @Author <a href="mailto:dongbiaozheng@ebnew.com">zhengdb</a>
 * @Date 2017/2/17
 */
public class ClientHandle extends SimpleChannelUpstreamHandler {
    //轮询定时器
    ...
    private static TimerTask timerTask = new TimerTask() {
        ...
        public void run(Timeout timeout) throws Exception {
            ...
            ChannelFuture channelFuture =  ClientThread.clientBootstrap.connect(ClientThread.remoteServerAddress);
